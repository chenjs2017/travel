                ...
                <div class="hotel-item-1">
                    <div class="thumb-header">
                        ...
                        <a href="<?php echo get_the_permalink(); ?>">
                            <?php the_post_thumbnail(array(420,300), array('alt' => TravelHelper::get_alt_image(get_post_thumbnail_id( ))))?>
                        </a>
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <a href="<?php the_permalink()?>">
                                <?php the_post_thumbnail(array(67,67), array('alt' => TravelHelper::get_alt_image(get_post_thumbnail_id( get_the_ID() ))))?>
                            </a>
                        </div>
                        <div class="col-xs-5">
