...
<div class="st-tour-information-list text-center <?php echo ($type_tour != 'daily_tour'?'info-4-col':'')?>">
    <ul>
        <li>
            <div class="item">
                <img src="<?php echo get_template_directory_uri().'/img/icons-new/icon-1.png'; ?>" width="65" height="63" alt="info-icon">
        ...
        <li>
            <div class="item">
                <img src="<?php echo get_template_directory_uri().'/img/icons-new/icon-2.png'; ?>" width="65" height="63" alt="info-icon">
        ...
        <li>
            <div class="item">
                <img src="<?php echo get_template_directory_uri().'/img/icons-new/icon-4.png'; ?>" width="65" height="63" alt="info-icon">
        ...
        <li>
            <div class="item">
                <img src="<?php echo get_template_directory_uri().'/img/icons-new/icon-5.png'; ?>" width="65" height="63" alt="info-icon">
        ...
        <li>
            <div class="item">
                <img src="<?php echo get_template_directory_uri().'/img/icons-new/icon-6.png'; ?>" width="65" height="63" alt="info-icon">
