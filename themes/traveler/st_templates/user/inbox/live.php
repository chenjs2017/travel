...
if(!empty($message_data)){
    ...
    $current_link = remove_query_arg('message_id', $current_link);
    ?>
    <div class="st-inbox-body-detail" id="wb-partner-message-detail">
        <a class="btn btn-default back-all-list" href="<?php echo esc_url($current_link); ?>"><i class="fa fa-arrow-circle-left "> <?php echo esc_html__('All messages',ST_TEXTDOMAIN); ?></i></a>
