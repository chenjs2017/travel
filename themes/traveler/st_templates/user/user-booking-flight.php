    ...
    <?php if(!empty($posts)) {
        ...
        foreach( $posts as $key => $value ) {
            ...
            <td><?php echo $value->order_item_id; ?></td>
                ...
                <td class="">
                    <?php
                    $date= $value->check_in; if($date) echo esc_html__('Depart Date: ', ST_TEXTDOMAIN).date('d/m/Y',strtotime($date)); ?><br>
                    <?php $date = $value->check_out ; if($date) echo esc_html__('Return Date: ', ST_TEXTDOMAIN).date('d/m/Y',strtotime($date)); ?>
                </td>
                <td class=""> <?php
