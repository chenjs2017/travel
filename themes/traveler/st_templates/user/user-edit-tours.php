...
<form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner">
    ...
    <div class="form-group form-group-icon-left">
        ...
        <input id="title" name="st_title" type="text" placeholder="<?php echo __('Name of tour', ST_TEXTDOMAIN); ?>" class="form-control" value="<?php echo stripslashes(STInput::request("st_title",$title) ); ?>">
