...
<div class="traveler-registration-steps">
	<div class="feature-section col three-col">
		<div>
			...
			<p><a href="https://shinehelp.ticksy.com/" target="_blank">Click here</a> to signup at our support center.&nbsp;View a tutorial&nbsp;<a href="http://shinetheme.com/documentation/traveler/" target="_blank"><?php echo __("here ", ST_TEXTDOMAIN ) ; ?>.</a>&nbsp;<?php echo __("This gives you access to our documentation, knowledgebase, video tutorials and ticket system.", ST_TEXTDOMAIN ) ; ?></p>
		</div>
		<div>
