...
<div data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-group input-daterange  form-group-<?php echo esc_attr($field_size)?> form-group-icon-left flight-input">
    ...
    <input id="field-flight-start" placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-control depart <?php echo esc_attr($is_required) ?>" value="<?php echo STInput::get('start') ?>" name="start" type="text" />
</div>
