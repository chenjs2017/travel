    ...
    $('.st-flight-location-name').each(function(index, el) {
        ...
        t.keydown(function(event) {
            ...
            if (event.which == 13) {
                ...
                var i_text = t.val();
                var val = $('div.option-wrapper1 .option.active').data('value');
                console.log(val);
                if( typeof i_text != 'undefined' && typeof val != 'undefined' ){
            ...
            if (event.which == 40 || event.which == 38 || event.which == 9) {
                if ($('.option-wrapper1 .option.active').length > 0) {
                    ...
                    $('.option-wrapper1 .option.active').removeClass('active');

                    if (event.which == 40) {
                        $('.option-wrapper1 .option').eq(index + 1).addClass('active');
                    }
                    if (event.which == 38) {
                        $('.option-wrapper1 .option').eq(index - 1).addClass('active');
                    }
                    ...
                    $('.option-wrapper1 .option').eq(0).addClass('active');
                }
