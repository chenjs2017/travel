<?php
    ...
    if ( !class_exists( 'ST_Ical_Sysc' ) ) {
        class ST_Ical_Sysc extends TravelerObject
        {
            ...
            private function import_event( $post_id, $post_type, $price, $start, $end, $available )
            {
                global $wpdb;
                $sql = "SELECT
                    count(id)
            ...
            private function import_event_tour( $post_id, $post_type, $adult_price, $child_price, $infant_price, $group_day, $start, $end, $available )
            {
                global $wpdb;
                $sql = "SELECT
                    count(id)
