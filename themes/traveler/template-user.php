                        ...
                        <?php }else{ ?>
                                    ...
                                    <ul class="sub-menu item">
                                        ...
                                        <?php if(STUser_f::_check_service_available_partner('st_flight')):?>
                                            <li class="<?php if($sc == 'dashboard-info' and STInput::request('type') == 'st_flight' ) echo 'active' ?>">
                                                <a href="<?php  echo add_query_arg('type', 'st_flight' , TravelHelper::get_user_dashboared_link($user_link, 'dashboard-info') ); ?>"> <i class="fa fa-plane"> &nbsp; </i><?php _e("Flight Statistics",ST_TEXTDOMAIN) ?></a>
                                            </li>
                                        <?php endif; ?>
                                    </ul>
                                </li>
                            ...
                            <li class="item <?php if($sc == 'inbox')echo 'active' ?>">
                                <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'inbox'); ?>"><i
                                        class="fa fa-inbox"></i><?php esc_html_e("Inbox Notification ",ST_TEXTDOMAIN) ?></a>
                            </li>
...
<!--                                            <li --><?php //if($sc == 'add-flight-booking') echo 'class="active"' ?><!-- >-->
<!--                                                <a href="--><?php //echo TravelHelper::get_user_dashboared_link($user_link, 'add-flight-booking'); ?><!--">-->
            ...
            <div class="user-content col-md-9">
                ...
                if(!empty( $_REQUEST[ 'id_user' ] )) {
                    ...
                    if(STUser_f::check_lever_partner( $lever )){
                        ...
                        if(in_array($sc,array("overview","setting","setting-info","wishlist","booking-history","certificate","write_review","inbox"))){
                            echo st()->load_template( 'user/user' , $sc , get_object_vars( $current_user ) );
                        }else{
